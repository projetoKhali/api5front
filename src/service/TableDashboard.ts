...
export async function postTableDashboardData(tableRequest: TableRequest): Promise<TableRowResponse> {
  
  try {
    const response = await axios.post<TableRowResponse>(`${API_URL}/api/v1/table/dashboard`, tableRequest);
